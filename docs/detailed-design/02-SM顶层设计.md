...
graph TB
    ...
    L1I --> L0ICN
    L0ICN --> Subcores
    Subcores -->|"barrier_mod"| BAR
    BAR -->|"barrier_state"| Subcores
```
...
graph TD
    ...
    SubArr --> Warps["Warp 集合<br/>(warp_id % NUM_SUBCORES == subcore_id)"]
    ...
    WarpState --> PhyWarp["Physical warp 数组 [0..MAX_WARPS_PER_SM-1]"]
