...
CUOPTS="$GENCODE_ARCH $GENCODE_SM70 $GENCODE_SM72 $GENCODE_SM75 $GENCODE_SM80 $GENCODE_SM86 $GENCODE_SM87 $GENCODE_SM89 $GENCODE_SM90 $GENCODE_SM120"
...
nvcc -Xptxas -v prototype_simple.cu $FLAGS $CUOPTS -o $BINDIR/$BINSUBDIR/cns_all -lcudart
