...
all:
	nvcc -O3 ${GENCODE_SM10} ${GENCODE_SM13} ${GENCODE_SM20} ${GENCODE_SM30} ${GENCODE_SM35} ${GENCODE_SM35} ${GENCODE_SM50} ${GENCODE_SM50} ${GENCODE_SM60} ${GENCODE_SM62} ${GENCODE_SM70} ${GENCODE_SM72} ${GENCODE_SM75} ${GENCODE_SM80} $(GENCODE_SM86) $(GENCODE_SM87) $(GENCODE_SM89) $(GENCODE_SM90) $(GENCODE_SM120) ${NVCC_ADDITIONAL_ARGS} ${CUFILES} -o ${EXECUTABLE} 
clean:
	rm -f *~ *.exe
