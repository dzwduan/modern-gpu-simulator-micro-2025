...
main(int argc, char **argv)
{
  ...
  /* Run the kernel code */
  {
    ...
    cudaTextureObject_t refTexObj;  /* Texture object for reference image */
    ...
    refTexObj = create_ref_texture(ref_ary);
    CUDA_ERRCK
    ...
    cudaFree(d_sads);
    CUDA_ERRCK
    cudaDestroyTextureObject(refTexObj);
    CUDA_ERRCK
